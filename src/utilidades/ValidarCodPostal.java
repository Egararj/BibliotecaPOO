...
public class ValidarCodPostal {
	...
	public static void ValidarCodPostal(String codPostal, String provincia) throws CodPostalException {
		...
		try{
		String numCodPostal = codPostal.substring(0,2);
		if(!provincia.equalsIgnoreCase(provincias.get(numCodPostal))) throw new CodPostalException();
		}catch (Exception e){
			throw new CodPostalException();
		}
